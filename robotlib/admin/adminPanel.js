...
var routting = function(message, speratedSection){
    ...
    //go to dictionary
    if (message.text == fn.mstr.dictionary['name'] || message.text == fn.mstr.dictionary['back'] || speratedSection[2] === fn.mstr.dictionary['name'])
        fn.m.dictionary.routting(message, speratedSection);
}
