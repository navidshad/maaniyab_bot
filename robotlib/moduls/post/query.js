var uploadSection = function(query,speratedQuery){
    ...
    fn.userOper.setSection(query.from.id, fn.str['mainMenu'] + '/' + fn.mstr.post['name'] + '/' + speratedQuery[speratedQuery.length-1], false);
    global.robot.bot.sendMessage(query.from.id, fn.mstr.post.edit['upload'], fn.generateKeyboard({section:fn.mstr.post['name']}, true));
}
